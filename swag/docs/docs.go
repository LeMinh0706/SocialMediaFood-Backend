...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/account.EmailRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/accounts/searching": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Who you want to search",
                        "name": "name",
                        "in": "query",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/db.SearchingAccountsRow"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/reset_password.ChangePasswordRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "reset_password.ChangePasswordRequest": {
            "type": "object",
            "required": [
                "kamehameha",
                "new_password"
